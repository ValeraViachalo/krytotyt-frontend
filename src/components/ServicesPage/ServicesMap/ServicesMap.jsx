...
export default function ServicesMap({ activeFilter, onFilterChange }) {
  const [hoveredService, setHoveredService] = useState(null);
  const [zoomLevel, setZoomLevel] = useState(0.75);
  const [worldSizeX, setWorldSizeX] = useState(3250);
  const [worldSizeY, setWorldSizeY] = useState(2050);
                    ...
                    if (isAnyHovered) {
                      ...
                      animProps = {
                        ...
                        transition: {
                          ...
                          repeat: Infinity,
                          ease: "easeInOut",
                          delay: (parseInt(service.id) * 1.37) % animSpeed,
                        },
                      };
                    } else {
                      animProps = {
