  ...
  return (
    <div className="player">
      <div className="player-content">
        <Image
          src="/assets/player-thumbnail.jpg"
          width={113}
          height={78}
        ...
        <div className="player__info">
          <span className="player__title">Human Rythm KRYTOTYT Guest Mix</span>
      ...
      <Link
        href="https://soundcloud.com/krytotytmusic/human-rythm-guest-mix"
        target="_blank"
