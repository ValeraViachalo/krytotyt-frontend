...
import { anim, AutoHeightAnim, MenuAnim } from "@/lib/helpers/anim";
        ...
        >
          ...
          <div className="form-pop-up">
            ...
            <button className="form-pop-up__close" onClick={closeForm}>
              ...
              >
                <g clipPath="url(#clip0_40000063_10018)">
                  <path
...
const ContactForm = ({ formText, closeForm }) => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    message: Yup.string(),
    legal: Yup.boolean()
      .oneOf([true], formText?.legalError)
      .required(formText?.legalError),
  });

  const initialValues = { name: "", email: "", message: "", legal: false };
                ...
                <div className="form-content">
                  ...
                  <div className="form-row">
                    <label className="legal-checkbox">
                      ...
                      />
                      <span
                        className={clsx("legal-checkbox__box", {
                          "legal-checkbox__box--error":
                            errors.legal && touched.legal,
                          "legal-checkbox__box--checked": values.legal,
                        })}
                      />
                      <span
